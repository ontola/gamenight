...
## Art and audio in this fork

None of the Fish Folk media is present here. It is CC BY-NC 4.0, which a
commercial GameNight build cannot use, so every image and sound was replaced
with CC0 work. The people listed further down are credited for the **code**,
which is unchanged and still theirs under MIT / Apache-2.0 — and for the
original art direction this fork departs from.

Replacement media, all CC0 (attribution optional, given gratefully):

- [Kenney](https://kenney.nl) — Platformer Characters, Platformer Art Deluxe,
  UI Pack, Impact Sounds, Interface Sounds, Digital Audio, Sci-Fi Sounds
- [Kay Lousberg](https://opengameart.org/content/2d-guns) — 2D Guns

Fonts are unchanged: **Fairfax SM** (Kreative Software) and **Ark Pixel**
(TakWolf), both SIL Open Font License 1.1.

Per-asset provenance is in [`tools/reskin/ASSET-SOURCES.md`](tools/reskin/ASSET-SOURCES.md).
