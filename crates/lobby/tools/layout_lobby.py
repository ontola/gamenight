...
def build():
    ...
    for tile in tiles:
        if tile['pos'][1] <= 2 and tile['pos'][0] not in (1,38): tile['idx']=84
    ...
    positions = {'qr_sign': [136., 352.], 'sign_in': [224., 263.],
                 ...
                 'music_screen': [1068., 117.], 'music_pause': [1068., 118.],
                 'music_skip': [1132., 118.], 'music_previous': [1004., 118.]}
    ...
    anchors = [160 + i * 96 for i in range(8)]
...
def validate(room, anchors):
    ...
    for x, feet in [(224,270), (500,96), (620,96), (740,96), (1004,96), (1068,96), (1132,96)]:
