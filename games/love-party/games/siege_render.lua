...
function M.draw(s, G, fonts, playerColor)
	...
	G.setColor(0.45, 0.72, 0.82)
	G.printf("TEAM SCORE", 460, 29, 350, "center")
	G.setFont(fonts.title)
	G.setColor(0.8, 1, 0.95)
	G.printf(tostring(s.teamScore), 460, 47, 350, "center")
	G.setFont(fonts.small)
	G.setColor(0.4, 0.85, 0.8)
	G.printf("WAVE " .. s.wave .. "     /     x" .. Siege.multiplier(s) .. " COMBO", 460, 88, 350, "center")
	G.setColor(0.12, 0.23, 0.28)
	G.rectangle("fill", 525, 113, 220, 3)
	G.setColor(0.3, 1, 0.8)
	G.rectangle("fill", 525, 113, 220 * s.comboTime / 2.5, 3)
